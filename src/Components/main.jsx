      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <img
            src={myPhoto}
            alt="Tatiana"
            className="w-48 h-48 md:w-56 md:h-56 rounded-full mx-auto mb-8 object-cover border-4 border-primary/20"
          />
          ...
          <div className="text-center mt-12">
            <a
              ...
              className="inline-block px-8 py-3 bg-primary text-white font-semibold rounded-lg 
                hover:bg-primary/90 transition-colors duration-200 transform hover:scale-105"
            >
              Get in touch
            </a>
          </div>
